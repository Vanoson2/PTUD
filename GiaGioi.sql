...
INSERT INTO `place_type` (`place_type_id`,`name`,`description`) VALUES (1,'Entire home','Entire home');
INSERT INTO `place_type` (`place_type_id`,`name`,`description`) VALUES (2,'Private room','Private room');
INSERT INTO `place_type` (`place_type_id`,`name`,`description`) VALUES (3,'Shared room','Shared room');
INSERT INTO `place_type` (`place_type_id`,`name`,`description`) VALUES (4,'Hotel','Hotel');
INSERT INTO `place_type` (`place_type_id`,`name`,`description`) VALUES (5,'Resort','Resort');
INSERT INTO `place_type` (`place_type_id`,`name`,`description`) VALUES (6,'Apartment','Apartment');
INSERT INTO `place_type` (`place_type_id`,`name`,`description`) VALUES (7,'Homestay','Homestay');
INSERT INTO `place_type` (`place_type_id`,`name`,`description`) VALUES (8,'Villa','Villa');
INSERT INTO `place_type` (`place_type_id`,`name`,`description`) VALUES (9,'Bungalow','Bungalow');
INSERT INTO `place_type` (`place_type_id`,`name`,`description`) VALUES (10,'Cottage','Cottage');

DELETE FROM `amenity`;
INSERT INTO `amenity` (`amenity_id`,`name`,`group_name`,`description`) VALUES (1,'Wi‑Fi','General','Wi‑Fi');
INSERT INTO `amenity` (`amenity_id`,`name`,`group_name`,`description`) VALUES (2,'Air conditioning','General','Air conditioning');
INSERT INTO `amenity` (`amenity_id`,`name`,`group_name`,`description`) VALUES (3,'Heating','General','Heating');
INSERT INTO `amenity` (`amenity_id`,`name`,`group_name`,`description`) VALUES (4,'Kitchen','General','Kitchen');
INSERT INTO `amenity` (`amenity_id`,`name`,`group_name`,`description`) VALUES (5,'Washer','General','Washer');
INSERT INTO `amenity` (`amenity_id`,`name`,`group_name`,`description`) VALUES (6,'Dryer','General','Dryer');
INSERT INTO `amenity` (`amenity_id`,`name`,`group_name`,`description`) VALUES (7,'TV','General','TV');
INSERT INTO `amenity` (`amenity_id`,`name`,`group_name`,`description`) VALUES (8,'Hair dryer','General','Hair dryer');
INSERT INTO `amenity` (`amenity_id`,`name`,`group_name`,`description`) VALUES (9,'Iron','General','Iron');
INSERT INTO `amenity` (`amenity_id`,`name`,`group_name`,`description`) VALUES (10,'Shampoo','General','Shampoo');
INSERT INTO `amenity` (`amenity_id`,`name`,`group_name`,`description`) VALUES (11,'Desk','General','Desk');
INSERT INTO `amenity` (`amenity_id`,`name`,`group_name`,`description`) VALUES (12,'Hangers','General','Hangers');
INSERT INTO `amenity` (`amenity_id`,`name`,`group_name`,`description`) VALUES (13,'Smoke alarm','General','Smoke alarm');
INSERT INTO `amenity` (`amenity_id`,`name`,`group_name`,`description`) VALUES (14,'First aid kit','General','First aid kit');
INSERT INTO `amenity` (`amenity_id`,`name`,`group_name`,`description`) VALUES (15,'Fire extinguisher','General','Fire extinguisher');
INSERT INTO `amenity` (`amenity_id`,`name`,`group_name`,`description`) VALUES (16,'Balcony','General','Balcony');
INSERT INTO `amenity` (`amenity_id`,`name`,`group_name`,`description`) VALUES (17,'Garden view','General','Garden view');
INSERT INTO `amenity` (`amenity_id`,`name`,`group_name`,`description`) VALUES (18,'City view','General','City view');
INSERT INTO `amenity` (`amenity_id`,`name`,`group_name`,`description`) VALUES (19,'Mountain view','General','Mountain view');
INSERT INTO `amenity` (`amenity_id`,`name`,`group_name`,`description`) VALUES (20,'Beach access','General','Beach access');
INSERT INTO `amenity` (`amenity_id`,`name`,`group_name`,`description`) VALUES (21,'Free parking','General','Free parking');
INSERT INTO `amenity` (`amenity_id`,`name`,`group_name`,`description`) VALUES (22,'Paid parking','General','Paid parking');
INSERT INTO `amenity` (`amenity_id`,`name`,`group_name`,`description`) VALUES (23,'Pool','General','Pool');
INSERT INTO `amenity` (`amenity_id`,`name`,`group_name`,`description`) VALUES (24,'Gym','General','Gym');
INSERT INTO `amenity` (`amenity_id`,`name`,`group_name`,`description`) VALUES (25,'Breakfast','General','Breakfast');
INSERT INTO `amenity` (`amenity_id`,`name`,`group_name`,`description`) VALUES (26,'24h check-in','General','24h check-in');
INSERT INTO `amenity` (`amenity_id`,`name`,`group_name`,`description`) VALUES (27,'Pets allowed','General','Pets allowed');
INSERT INTO `amenity` (`amenity_id`,`name`,`group_name`,`description`) VALUES (28,'Child-friendly','General','Child-friendly');
INSERT INTO `amenity` (`amenity_id`,`name`,`group_name`,`description`) VALUES (29,'BBQ grill','General','BBQ grill');
INSERT INTO `amenity` (`amenity_id`,`name`,`group_name`,`description`) VALUES (30,'Bicycle rental','General','Bicycle rental');

DELETE FROM `service`;
INSERT INTO `service` (`service_id`,`name`,`description`) VALUES (1,'Airport pickup','Airport pickup');
INSERT INTO `service` (`service_id`,`name`,`description`) VALUES (2,'Daily cleaning','Daily cleaning');
INSERT INTO `service` (`service_id`,`name`,`description`) VALUES (3,'Motorbike rental','Motorbike rental');
INSERT INTO `service` (`service_id`,`name`,`description`) VALUES (4,'Breakfast','Breakfast');
INSERT INTO `service` (`service_id`,`name`,`description`) VALUES (5,'Laundry','Laundry');
INSERT INTO `service` (`service_id`,`name`,`description`) VALUES (6,'City tour','City tour');
INSERT INTO `service` (`service_id`,`name`,`description`) VALUES (7,'Cooking class','Cooking class');
INSERT INTO `service` (`service_id`,`name`,`description`) VALUES (8,'Late checkout','Late checkout');
INSERT INTO `service` (`service_id`,`name`,`description`) VALUES (9,'Early check-in','Early check-in');
INSERT INTO `service` (`service_id`,`name`,`description`) VALUES (10,'Car rental','Car rental');
